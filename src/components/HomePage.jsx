...
import { FiMenu, FiSearch, FiMail, FiBell, FiSettings, FiUser, FiSun, FiMoon, FiHome, FiUsers, FiTruck, FiShoppingCart, FiPackage, FiLogOut, FiChevronDown } from 'react-icons/fi';
        ...
        <nav className="sidebar-nav">
          <ul>
            ...
            <li className="has-dropdown">
              <a href="#" onClick={() => setPagesDropdownOpen(!pagesDropdownOpen)}>
                <FiPackage />
                <span>Pages</span>
